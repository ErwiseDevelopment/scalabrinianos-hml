...
<div id="page" class="site">
    ...
    <header id="masthead" class="l-header site-header navbar-static-top <?php echo wp_bootstrap_starter_bg_class(); ?>" role="banner">

        <div class="container-fluid">

            <nav class="l-navbar navbar navbar-expand-xl p-0 px-lg-3">
